...
## Why these codes are self-hosted

The previous printed cards used a QR from a paid redirect service. When the
subscription lapsed the codes stopped working, and prehab cards were withdrawn
from clinic for several months as a result — patients who should have been
exercising before their operation got nothing.

These codes have no account, no subscription and no third party. They are static
files generated by `segno`, pointing at a domain held to 2036. Nothing can expire
underneath them.
